...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,754 | 🐛 128 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,460 | 🐛 472 | 🌐 C | 📅 2026-08-12 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,197 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-02.
...
* [typeid-js](https://github.com/jetify-com/typeid-js) ⭐ 431 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-29 – Type-safe, K-sortable, and globally unique identifiers inspired by Stripe IDs
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,678 | 🐛 87 | 🌐 Python | 📅 2026-08-18.
