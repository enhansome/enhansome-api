...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,846 | 🐛 135 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,558 | 🐛 478 | 🌐 C | 📅 2026-09-01 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,704 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,154 | 🐛 91 | 🌐 Python | 📅 2026-09-01.
