...
* [HTTP API Design by Heroku](https://github.com/interagent/http-api-design) ⭐ 13,683 | 🐛 30 | 📅 2024-01-16.
...
* [Auth Boss](https://github.com/teesloane/Auth-Boss) ⭐ 2,873 | 🐛 1 | 📅 2017-03-01 – Learn about different authentication methodologies on the web.
...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,857 | 🐛 137 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,488 | 🐛 337 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,558 | 🐛 479 | 🌐 C | 📅 2026-09-01 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,708 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
* [FakeRest](https://github.com/marmelab/FakeRest) ⭐ 456 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-03 – Patch XMLHttpRequest to fake a REST API client-side.
...
* [slate](https://github.com/tripit/slate) ⚠️ Archived.
* [whiteboard](https://github.com/mpociot/whiteboard) ⭐ 1,223 | 🐛 17 | 🌐 JavaScript | 📅 2021-01-29.
* [docbox](https://github.com/tmcw/docbox) ⭐ 1,131 | 🐛 6 | 🌐 CSS | 📅 2020-04-21.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,201 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-09.
...
* [hashids](https://github.com/niieani/hashids.js) ⭐ 4,287 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-12 – A small JavaScript library to generate YouTube-like ids from numbers.
* [typeid-js](https://github.com/jetify-com/typeid-js) ⭐ 436 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-29 – Type-safe, K-sortable, and globally unique identifiers inspired by Stripe IDs
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,211 | 🐛 81 | 🌐 Python | 📅 2026-09-01.
