...
* [Auth Boss](https://github.com/teesloane/Auth-Boss) ⭐ 2,874 | 🐛 1 | 📅 2017-03-01 – Learn about different authentication methodologies on the web.
...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,855 | 🐛 137 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,486 | 🐛 338 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,564 | 🐛 479 | 🌐 C | 📅 2026-09-01 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,707 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [whiteboard](https://github.com/mpociot/whiteboard) ⭐ 1,225 | 🐛 17 | 🌐 JavaScript | 📅 2021-01-29.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,201 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-01.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,200 | 🐛 80 | 🌐 Python | 📅 2026-09-01.
