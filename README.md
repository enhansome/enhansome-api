...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,861 | 🐛 137 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,492 | 🐛 337 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,576 | 🐛 480 | 🌐 C | 📅 2026-09-01 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,705 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,200 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-09.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,236 | 🐛 81 | 🌐 Python | 📅 2026-09-01.
