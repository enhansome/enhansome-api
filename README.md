...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,916 | 🐛 146 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,588 | 🐛 341 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,718 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [whiteboard](https://github.com/mpociot/whiteboard) ⭐ 1,223 | 🐛 15 | 🌐 JavaScript | 📅 2021-01-29.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,204 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-11.
...
* [hashids](https://github.com/niieani/hashids.js) ⭐ 4,291 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-12 – A small JavaScript library to generate YouTube-like ids from numbers.
* [typeid-js](https://github.com/jetify-com/typeid-js) ⭐ 439 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-29 – Type-safe, K-sortable, and globally unique identifiers inspired by Stripe IDs
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,637 | 🐛 82 | 🌐 Python | 📅 2026-09-26.
