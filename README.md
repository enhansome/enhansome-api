...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,866 | 🐛 138 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,498 | 🐛 338 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,584 | 🐛 480 | 🌐 C | 📅 2026-09-01 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,706 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,258 | 🐛 81 | 🌐 Python | 📅 2026-09-01.
