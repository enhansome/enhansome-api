...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,752 | 🐛 128 | 📅 2026-05-03 – A public list of APIs from round the web.
* [public apis](https://github.com/toddmotto/public-apis) ⭐ 2,736 | 🐛 11 | 📅 2024-06-23 – A collective list of public JSON APIs for use in web development.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,429 | 🐛 330 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,458 | 🐛 473 | 🌐 C | 📅 2026-08-12 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,691 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,196 | 🐛 49 | 🌐 JavaScript | 📅 2026-08-02.
...
* [typeid-js](https://github.com/jetify-com/typeid-js) ⭐ 430 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-29 – Type-safe, K-sortable, and globally unique identifiers inspired by Stripe IDs
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,653 | 🐛 85 | 🌐 Python | 📅 2026-08-17.
