...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,770 | 🐛 129 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,439 | 🐛 332 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,682 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,200 | 🐛 30 | 🌐 JavaScript | 📅 2026-08-20.
...
* [typeid-js](https://github.com/jetify-com/typeid-js) ⭐ 433 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-29 – Type-safe, K-sortable, and globally unique identifiers inspired by Stripe IDs
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,743 | 🐛 75 | 🌐 Python | 📅 2026-08-19.
