...
* [HTTP API Design by Heroku](https://github.com/interagent/http-api-design) ⭐ 13,686 | 🐛 30 | 📅 2024-01-16.
...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,730 | 🐛 127 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,418 | 🐛 329 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,449 | 🐛 472 | 🌐 C | 📅 2026-08-12 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,701 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,195 | 🐛 48 | 🌐 JavaScript | 📅 2026-08-02.
...
* [typeid-js](https://github.com/jetify-com/typeid-js) ⭐ 430 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-29 – Type-safe, K-sortable, and globally unique identifiers inspired by Stripe IDs
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 101,575 | 🐛 72 | 🌐 Python | 📅 2026-08-12.
