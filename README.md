...
* [HTTP API Design by Heroku](https://github.com/interagent/http-api-design) ⭐ 13,682 | 🐛 30 | 📅 2024-01-16.
...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,871 | 🐛 138 | 📅 2026-05-03 – A public list of APIs from round the web.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,507 | 🐛 338 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,706 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,201 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-11.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,309 | 🐛 82 | 🌐 Python | 📅 2026-09-01.
