...
* [Awesome APIs Directory](https://github.com/Abhishaker17/Awesome-APIs) ⭐ 23,832 | 🐛 125 | 📅 2026-05-03 – A public list of APIs from round the web.
* [public apis](https://github.com/toddmotto/public-apis) ⭐ 2,742 | 🐛 12 | 📅 2024-06-23 – A collective list of public JSON APIs for use in web development.
...
* [httpie](https://github.com/jkbrzt/httpie) ⭐ 38,479 | 🐛 335 | 🌐 Python | 📅 2024-12-17 – Command line HTTP client, far more dev-friendly than `curl`.
* [jq](https://github.com/stedolan/jq) ⭐ 35,542 | 🐛 477 | 🌐 C | 📅 2026-09-01 – Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [json-server](https://github.com/typicode/json-server) ⭐ 75,698 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 – Get a full fake REST API with zero coding in less than 30 seconds.
...
* [whiteboard](https://github.com/mpociot/whiteboard) ⭐ 1,226 | 🐛 17 | 🌐 JavaScript | 📅 2021-01-29.
...
* [morgan for expressjs](https://github.com/expressjs/morgan) ⭐ 8,201 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-01.
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 102,063 | 🐛 81 | 🌐 Python | 📅 2026-09-01.
